...
public class WholeBakedSeaBassItem extends BlockItem {
    public WholeBakedSeaBassItem(Item.Properties properties) {
        super(ModBlocks.WHOLE_BAKED_SEA_BASS_PLACED.get(), properties);
    }
    @Override
