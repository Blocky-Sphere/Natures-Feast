...
public class MarinatedDuckBreastItem extends BlockItem {
    public MarinatedDuckBreastItem(Properties properties) {
        super(ModBlocks.MARINATED_DUCK_BREAST_PLACED.get(), properties);
    }
    @Override
